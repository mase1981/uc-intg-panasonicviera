...
VIERA_KEYS = {
    ...
    # Additional mappings for Remote 3 physical buttons
    "MUTE_TOGGLE": "NRC_MUTE-ONOFF",
    "DPAD_UP": "NRC_UP-ONOFF",
    "DPAD_DOWN": "NRC_DOWN-ONOFF",
    "DPAD_LEFT": "NRC_LEFT-ONOFF",
    "DPAD_RIGHT": "NRC_RIGHT-ONOFF",
    "DPAD_MIDDLE": "NRC_ENTER-ONOFF",
...
class PanasonicVieraRemote(Remote):
    ...
    def _get_static_pages(self) -> list[dict]:
        """Return the static UI pages for navigation, channels, transort and inputs."""
        return [
            {
                "page_id": "navigation",
                "name": "Navigation",
                ...
                "items": [
                    {"type": "text", "icon": "uc:power-off", "command": {"cmd_id": "POWER"}, "location": {"x": 0, "y": 0}},
                    {"type": "icon", "icon": "uc:house-blank", "command": {"cmd_id": "HOME"}, "location": {"x": 1, "y": 0}},
                    {"type": "text", "text": "TV", "command": {"cmd_id": "TV"}, "location": {"x": 2, "y": 0}},
                    {"type": "text", "text": "AV", "command": {"cmd_id": "AV"}, "location": {"x": 3, "y": 0}},
                    {"type": "icon", "icon": "uc:align-justify", "command": {"cmd_id": "MENU"}, "location": {"x": 0, "y": 1}},
                    {"type": "icon", "icon": "uc:ballot", "command": {"cmd_id": "GUIDE"}, "location": {"x": 1, "y": 1}},
                    {"type": "text", "text": "Netflix", "command": {"cmd_id": "NETFLIX"}, "location": {"x": 2, "y": 1}},
                    {"type": "text", "text": "Apps", "command": {"cmd_id": "APPS"}, "location": {"x": 3, "y": 1}},
                    {"type": "icon", "icon": "uc:info", "command": {"cmd_id": "INFO"}, "location": {"x": 0, "y": 2}},
                    {"type": "icon", "icon": "uc:chevron-up", "command": {"cmd_id": "UP"}, "location": {"x": 1, "y": 2}},
                    {"type": "icon", "icon": "uc:xmark", "command": {"cmd_id": "EXIT"}, "location": {"x": 2, "y": 2}},
                    {"type": "icon", "icon": "uc:chevron-left", "command": {"cmd_id": "LEFT"}, "location": {"x": 0, "y": 3}},
                    {"type": "icon", "icon": "uc:circle-check", "command": {"cmd_id": "OK"}, "location": {"x": 1, "y": 3}},
                    {"type": "icon", "icon": "uc:chevron-right", "command": {"cmd_id": "RIGHT"}, "location": {"x": 2, "y": 3}},
                    {"type": "text", "text": "Option", "command": {"cmd_id": "OPTION"}, "location": {"x": 0, "y": 4}},
                    {"type": "icon", "icon": "uc:chevron-down", "command": {"cmd_id": "DOWN"}, "location": {"x": 1, "y": 4}},
                    {"type": "icon", "icon": "uc:reply", "command": {"cmd_id": "RETURN"}, "location": {"x": 2, "y": 4}},
                    {"type": "icon", "icon": "uc:circle-r", "command": {"cmd_id": "RED"}, "location": {"x": 0, "y": 5}},
                    {"type": "icon", "icon": "uc:circle-g", "command": {"cmd_id": "GREEN"}, "location": {"x": 1, "y": 5}},
                    {"type": "icon", "icon": "uc:circle-y", "command": {"cmd_id": "YELLOW"}, "location": {"x": 2, "y": 5}},
                    {"type": "icon", "icon": "uc:circle-b", "command": {"cmd_id": "BLUE"}, "location": {"x": 3, "y": 5}},
                ],
            },
            {
                "page_id": "channels",
                ...
                "items": [
                    {"type": "icon", "icon": "uc:1", "command": {"cmd_id": "NUM_1"}, "location": {"x": 0, "y": 0}},
                    {"type": "icon", "icon": "uc:2", "command": {"cmd_id": "NUM_2"}, "location": {"x": 1, "y": 0}},
                    {"type": "icon", "icon": "uc:3", "command": {"cmd_id": "NUM_3"}, "location": {"x": 2, "y": 0}},
                    {"type": "icon", "icon": "uc:arrow-up-long", "command": {"cmd_id": "CH_UP"}, "location": {"x": 3, "y": 0}},
                    {"type": "icon", "icon": "uc:4", "command": {"cmd_id": "NUM_4"}, "location": {"x": 0, "y": 1}},
                    {"type": "icon", "icon": "uc:5", "command": {"cmd_id": "NUM_5"}, "location": {"x": 1, "y": 1}},
                    {"type": "icon", "icon": "uc:6", "command": {"cmd_id": "NUM_6"}, "location": {"x": 2, "y": 1}},
                    {"type": "icon", "icon": "uc:7", "command": {"cmd_id": "NUM_7"}, "location": {"x": 0, "y": 2}},
                    {"type": "icon", "icon": "uc:8", "command": {"cmd_id": "NUM_8"}, "location": {"x": 1, "y": 2}},
                    {"type": "icon", "icon": "uc:9", "command": {"cmd_id": "NUM_9"}, "location": {"x": 2, "y": 2}},
                    {"type": "icon", "icon": "uc:arrow-down-long", "command": {"cmd_id": "CH_DOWN"}, "location": {"x": 3, "y": 2}},
                    {"type": "icon", "icon": "uc:question", "command": {"cmd_id": "EHELP"}, "location": {"x": 0, "y": 3}},
                    {"type": "icon", "icon": "uc:0", "command": {"cmd_id": "NUM_0"}, "location": {"x": 1, "y": 3}},
                    {"type": "icon", "icon": "uc:arrows-rotate", "command": {"cmd_id": "LAST_VIEW"}, "location": {"x": 2, "y": 3}},
                ],
            },
            {
                "page_id": "transport_input",
                "name": "Transport & Input",
                "grid": {"width": 4, "height": 5},
                "items": [
                    {"type": "icon", "icon": "uc:backward", "command": {"cmd_id": "REW"}, "location": {"x": 0, "y": 0}},
                    {"type": "icon", "icon": "uc:play", "command": {"cmd_id": "PLAY"}, "location": {"x": 1, "y": 0}},
                    {"type": "icon", "icon": "uc:forward", "command": {"cmd_id": "FF"}, "location": {"x": 2, "y": 0}},
                    {"type": "icon", "icon": "uc:backward-fast", "command": {"cmd_id": "SKIP_BACK"}, "location": {"x": 0, "y": 1}},
                    {"type": "icon", "icon": "uc:pause", "command": {"cmd_id": "PAUSE"}, "location": {"x": 1, "y": 1}},
                    {"type": "icon", "icon": "uc:forward-fast", "command": {"cmd_id": "SKIP_FWD"}, "location": {"x": 2, "y": 1}},
                    {"type": "text", "text": "My App", "command": {"cmd_id": "MY_APP"}, "location": {"x": 0, "y": 2}},
                    {"type": "icon", "icon": "uc:square-small", "command": {"cmd_id": "STOP"}, "location": {"x": 1, "y": 2}},
                    {"type": "icon", "icon": "uc:circle-dot", "command": {"cmd_id": "REC"}, "location": {"x": 2, "y": 2}},
                    {"type": "text", "text": "Aspect", "command": {"cmd_id": "ASPECT"}, "location": {"x": 0, "y": 3}},
                    {"type": "text", "text": "Text", "command": {"cmd_id": "TEXT"}, "location": {"x": 1, "y": 3}},
                    {"type": "text", "text": "STTL", "command": {"cmd_id": "STTL"}, "location": {"x": 2, "y": 3}},
                    {"type": "text", "text": "HDMI1", "command": {"cmd_id": "HDMI1"}, "location": {"x": 0, "y": 4}},
                    {"type": "text", "text": "HDMI2", "command": {"cmd_id": "HDMI2"}, "location": {"x": 1, "y": 4}},
                    {"type": "text", "text": "HDMI3", "command": {"cmd_id": "HDMI3"}, "location": {"x": 2, "y": 4}},
                    {"type": "text", "text": "HDMI4", "command": {"cmd_id": "HDMI4"}, "location": {"x": 3, "y": 4}},
                ],
            },
        ]
